            ...
            <div class="flex-1 overflow-y-auto overflow-x-hidden aside-scrollbars dark:aside-scrollbars-[slate]">
                <ul>
                    <li><a aria-current="page"
                            class="router-link-active router-link-exact-active flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none aside-menu-item-active font-bold"><svg
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12 aside-menu-item-active font-bold">Dashboard</span><!--v-if--></a><!--v-if-->
                    </li>
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Tables</span><!--v-if--></a><!--v-if-->
                    </li>
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Forms</span><!--v-if--></a><!--v-if-->
                    </li>
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">UI</span><!--v-if--></a><!--v-if--></li>
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                    <path fill="currentColor"
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Responsive</span><!--v-if--></a><!--v-if-->
                    </li>
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                    ...
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Profile</span><!--v-if--></a><!--v-if-->
                    </li>
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Login</span><!--v-if--></a><!--v-if-->
                    </li>
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Error</span><!--v-if--></a><!--v-if-->
                    </li>
                    <li><a class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                        ...
                        <ul class="aside-menu-dropdown hidden">
                            <li><a
                                    class="flex cursor-pointer py-3 px-6 text-sm aside-menu-item dark:text-slate-300 dark:hover:text-white"><!--v-if--><span
                                        class="grow text-ellipsis line-clamp-1 pr-12">Item
                                        One</span><!--v-if--></a><!--v-if--></li>
                            <li><a
                                    class="flex cursor-pointer py-3 px-6 text-sm aside-menu-item dark:text-slate-300 dark:hover:text-white"><!--v-if--><span
                                        class="grow text-ellipsis line-clamp-1 pr-12">Item
                                        Two</span><!--v-if--></a><!--v-if--></li>
                        </ul>
                    </li>
                    <li><a href="https://github.com/justboil/admin-one-vue-tailwind" target="_blank"
                            class="flex cursor-pointer py-3 aside-menu-item dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                    <path fill="currentColor"
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">GitHub</span><!--v-if--></a><!--v-if-->
                    </li>
            ...
            <ul>
                <li><a
                        class="flex cursor-pointer py-3 border-blue-600 dark:border-blue-500 ring-blue-300 dark:ring-blue-700 bg-blue-600 dark:bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-700 hover:dark:bg-blue-600 hover:dark:border-blue-600"><span
                            ...
                            class="grow text-ellipsis line-clamp-1 pr-12">Logout</span><!--v-if--></a><!--v-if--></li>
            </ul>
        </div>
    </aside>
</template>
