    ...
    <nav
        ...
        <div class="flex lg:items-stretch xl:max-w-6xl xl:mx-auto">
            ...
            <div class="flex flex-1 items-stretch h-14">
                ...
                <div
                    class="flex my-2 mx-3 navbar-item-label items-center cursor-pointer dark:text-white dark:hover:text-slate-400">
                    <div class="relative"><input placeholder="Search (ctrl+k)" type="text"
                            class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border-0 bg-transparent"><!--v-if-->
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <!--v-if--><span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="flex items-center"><!--v-if--><span
                                    ...
                                    </svg></span><span class="px-2 transition-colors">Item One</span><!--v-if--></div>
                            <!--v-if-->
                        </div>
                        <div
                            class="block lg:flex items-center relative cursor-pointer navbar-item-label dark:text-white dark:hover:text-slate-400 py-2 px-3">
                            <div class="flex items-center"><!--v-if--><span
                                    ...
                                    </svg></span><span class="px-2 transition-colors">Item Two</span><!--v-if--></div>
                            <!--v-if-->
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center"><!--v-if--><span
                                    ...
                                    </svg></span><span class="px-2 transition-colors">Item Last</span><!--v-if--></div>
                            <!--v-if-->
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center"><!--v-if--><span
                            ...
                            </svg></span><span class="px-2 transition-colors lg:hidden">GitHub</span><!--v-if--></div>
                    <!--v-if-->
                </a><a
                    class="block lg:flex items-center relative cursor-pointer navbar-item-label dark:text-white dark:hover:text-slate-400 py-2 px-3 lg:w-16 lg:justify-center"
                    ...
                    <div class="flex items-center"><!--v-if--><span
                            ...
                            </svg></span><span class="px-2 transition-colors lg:hidden">React version</span><!--v-if-->
                    </div><!--v-if-->
                </a>
                <div
                    class="block lg:flex items-center relative cursor-pointer navbar-item-label dark:text-white dark:hover:text-slate-400 py-2 px-3 lg:w-16 lg:justify-center">
                    <div class="flex items-center"><!--v-if--><span
                            ...
                            </svg></span><span class="px-2 transition-colors lg:hidden">Log out</span><!--v-if--></div>
                    <!--v-if-->
                </div>
            </div>
        </div>
