<template>
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 19h4a1 1 0 0 0 1-1v-1a3 3 0 0 0-3-3h-2m-2.236-4a3 3 0 1 0 0-4M3 18v-1a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v1a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Zm8-10a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
      ...
      <div class="search-bar flex justify-end mb-6">
        ...
        <button @click="filterPosts" class="btn-secondary ml-3">검색</button><div class="p-3 lg:px-6 border-t border-gray-100 dark:border-slate-800">
...
const posts = [
  ...
  <style scoped>
  table {
    background-color: #ffffff; /* 테이블 배경색을 흰색으로 변경 */
}

th, td {
    border: 1px solid #4F493F; /* 셀 경계 */
    padding: 8px; /* 셀 안쪽 여백 */
